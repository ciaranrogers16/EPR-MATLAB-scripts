...
Exp.mwFreq = MWFQ;
Exp.Field = 4400; % Field position mT 
...
%% Simulation of mononuclear systems: Chrysina
Sys1.S = 3; 
Sys1.g = [1.99]; 
Sys1.Nucs = '55Mn, 1H'; 
...
save('EDNMR_Wband_4p4T_Chyrsina_simulation_norm.mat')